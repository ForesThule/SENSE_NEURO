...
#
#  Бенд:    EF:21:DE:1C:A3:67  (env NEIRY_ADDR переопределяет)
...
PORT = int(os.environ.get('NEIRY_PORT', 9001))          # метрики
EVT_PORT = int(os.environ.get('NEIRY_EVT_PORT', 9011))   # события
