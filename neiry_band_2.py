...
#
#  Бенд:    C6:0D:7C:18:44:AA  (env NEIRY_ADDR переопределяет)
...
PORT = int(os.environ.get('NEIRY_PORT', 9002))          # метрики
EVT_PORT = int(os.environ.get('NEIRY_EVT_PORT', 9012))   # события
