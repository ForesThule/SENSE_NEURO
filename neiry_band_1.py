...
#
#  Бенд:    F7:14:0E:FE:9D:20  (env NEIRY_ADDR переопределяет)
...
PORT = int(os.environ.get('NEIRY_PORT', 9003))          # метрики
EVT_PORT = int(os.environ.get('NEIRY_EVT_PORT', 9013))   # события
