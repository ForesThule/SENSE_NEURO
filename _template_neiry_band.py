# -*- coding: utf-8 -*-
# =====================================================================
#  Neiry -> головной TouchDesigner (Эфир) : ридер бенда стены @@LABEL@@
#  ЭКЗЕМПЛЯР @@N@@ из 3 — все три бенда на ОДНОЙ машине, по процессу на бенд:
...
#   - лок экземпляра: localhost:@@LOCKPORT@@ (дубль выходит сам)
...
#   - сдвиг старта @@DELAY@@с, чтобы после ребута три процесса не ломились хором
#   - heartbeat: logs/neiry_heartbeat_@@N@@.txt (~1/с, его ждёт NEURWATCH)
#
...
#   - faulthandler -> logs/crash_@@N@@.log; почасовые логи logs/reader_@@N@@/.
#
#  Запуск: START_NEIRY_BAND_@@N@@.bat (задача NEIRYSTART@@N@@, onlogon)
# =====================================================================
...
BAND_LABEL = '@@LABEL@@'   # стена: R / C / L
BAND_ADDR = '@@ADDR@@'     # свой бенд этого экземпляра
INSTANCE = @@N@@           # номер экземпляра 1..3
START_DELAY = @@DELAY@@    # сдвиг старта, с
